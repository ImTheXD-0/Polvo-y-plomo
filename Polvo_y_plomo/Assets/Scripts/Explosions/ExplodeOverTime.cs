...
/// </summary>
public class ExplodeOverTime : MonoBehaviour
{
    ...
    /// <summary>
    /// Se llama una sola vez al cargarse el objeto en escena, si esta activo. Si no lo está, se llama al activarse por primera vez.
